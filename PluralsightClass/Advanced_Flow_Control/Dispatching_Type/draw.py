from dispatching import Group, Circle, Rectangle, Polygon
...
def draw(shape):
    ...
    """
    Looks better but is fragile subclass's will brake this 
    ...
    """
    """
    really flexible with class's yet is extremely fragile when refactoring - class name changes are bad 
